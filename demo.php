...
function activitéOnglet( $nom ) {
	if(!isset($_GET['ctn'])) return "";
	else if($_GET['ctn'] == $nom)
		return "active";
	return "";
}
...
<html>
	...
	<body>
		...
		<menu id="menu">
			<li class="<?=activitéOnglet('projet');?>"><a href="?ctn=projet">Projet</a></li>
			<li class="<?=activitéOnglet('demo');?>"><a href="?ctn=demo">Exemple</a></li>
			<li class="<?=activitéOnglet('GPL');?>"><a href="?ctn=GPL">License</a></li>
		</menu>
		<contenu id="ctn">
		<?
